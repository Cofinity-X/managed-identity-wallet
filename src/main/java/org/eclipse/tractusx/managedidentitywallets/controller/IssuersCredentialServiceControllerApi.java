 ...
 */
public interface IssuersCredentialServiceControllerApi {

    /**
     * The constant API_TAG_VERIFIABLE_CREDENTIAL_ISSUER.
     */
    String API_TAG_VERIFIABLE_CREDENTIAL_ISSUER = "Verifiable Credential - Issuer";

    /**
     * The constant API_TAG_VERIFIABLE_CREDENTIAL_VALIDATION.
     */
    String API_TAG_VERIFIABLE_CREDENTIAL_VALIDATION = "Verifiable Credential - Validation";
    ...
    ResponseEntity<PageImpl<VerifiableCredential>> getCredentials(
            @Parameter(name = "credentialId", description = "Credential Id", examples = {@ExampleObject(name = "Credential Id", value = "did:web:localhost:BPNL000000000000#12528899-160a-48bd-ba15-f396c3959ae9")}) @RequestParam(required = false) String credentialId,
            ...
            @Min(0) @Max(Integer.MAX_VALUE) @Parameter(description = "Number of records per page") @RequestParam(required = false, defaultValue =
    ...
    ResponseEntity<VerifiableCredential> issueMembershipCredential(
    ...
    ResponseEntity<VerifiableCredential> issueDismantlerCredential(
    ...
    ResponseEntity<VerifiableCredential> issueFrameworkCredential(
    ...
    ResponseEntity<Map<String, Object>> credentialsValidation(
    ...
    public ResponseEntity<VerifiableCredential> issueCredentialUsingBaseWallet(
            @Parameter(description = "Holder DID", examples = {@ExampleObject(description = "did", name = "did", value = "did:web:localhost:BPNL000000000000")}) @RequestParam(name = "holderDid") String holderDid,
            @RequestBody Map<String, Object> data,
            Principal principal
    );
}
